...
namespace LocacaoSala.Infra.CrossCutting.IoC
{
    public static class ContainerManager
    {
        ...
        public static void Load(HttpConfiguration config)
        {
            ...
            Container.RegisterMany(new[] { typeof(IMediator).GetAssembly(), typeof(SalaRepository).GetAssembly(), typeof(SalaCommandHandler).GetAssembly() }, type => type.GetTypeInfo().IsInterface);
